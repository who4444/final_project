...
class Ui_Library_Control(Ui_Library):
    ...
    def connect_admin_auth(self):
        ...
        self.Pbutton_initialize_admin.clicked.connect(self.admin_initialize)
    ...
    def clear_all_user_authentication(self):
        ...
        self.DateEdit_Birthday_signup_user.clear()
    ...
    def user_sign_up(self):
        ...
        birthday = self.DateEdit_Birthday_signup_user.date().toString("yyyy-MM-dd")
        ...
        if not success:
            CustomMessageBox.warning(self.mainwindow, "Password Error", message)
            return
        success, message = self.validate_user_info(username, password, name, address, phone_number, gender, birthday, interest)

        try:
            # Register user
            if self.user_manager.add_registered_info(
                name, gender, username, password, 
                birthday, address, phone_number, interest
            ):
                # Update UI
                self.switch_to_page("user_info_page")
                self.load_user_info_profile()
    ...
    def user_logout(self):
        ...
        reply = CustomMessageBox.question(
            self.mainwindow,
            "Warning",
            "Are you sure you want to logout, unsaved changeds will be lost?",
    ...
    def edit_user_profile_enable(self):
        ...
        self.Label_mode_user_profile.setText("Now you can edit")
    ...
    def load_user_info_profile(self):
        ...
        if user_info:
            ...
            self.DDateEdit_Birthday_profile_user.setDate(dob_date)
    ...
    def applychanges_user_profile(self):
        ...
        self.Label_mode_user_profile.setText("It is view mode")
    def change_profile_user(self):
        ...
        new_dob = self.DateEdit_Birthday_profile_user.text()
    ...
    def admin_initialize(self):
        ...
        if result == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self.Pbutton_initialize_admin.setEnabled(True)
            except Exception as e:

...
class Ui_Library_Control(Ui_Library):
    ...
    def clear_all_user_authentication(self):
        ...
        self.Spinbox_age_signup_user.clear()
    ...
    def user_sign_up(self):
        ...
        age = self.Spinbox_age_signup_user.text()  
        ...
        if not success:
            CustomMessageBox.warning(self.mainwindow, "Password Error", message)
            return
        success, message = self.validate_user_info(username, password, name, address, phone_number, gender, age, interest)
    ...
    def validate_user_info(self, User_name: str, Password: str, 
                       ...
                       Gender: str, Age: int, Interests: str) -> bool:
    ...
    def load_user_info_profile(self):
        ...
        if user_info:
            username, name, gender, address, age, phone_num, interests = user_info
    ...
    def change_profile_user(self):
        ...
        try:
            print(f"Updating profile with: {new_username}, {new_name}, {new_address}, {new_phone_number}, {new_gender}, {new_age}, {new_interest}")
            self.user_manager.update_profile(new_username, new_name, new_address, new_phone_number, new_gender, new_age, new_interest)
        except Exception as e:
